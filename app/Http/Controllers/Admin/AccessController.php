...
class AccessController extends Controller
{
    ...
    public function index(Department $department)
    {
        ...
        $docTypes = DocType::orderBy('name')->get(['id','name']);
    ...
    public function store(Request $request, Department $department)
    {
        ...
        // Cegah duplikasi kombinasi (user_id + department_id + scope_type + scope_id)
    ...
    private function authorizeManage(Department $department): void
    {
        ...
        // gunakan relasi admins() di model Department (role dari pivot department_user)
