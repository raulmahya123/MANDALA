    ...
    <aside id="sidebar"
      ...
      <nav class="px-2 py-3 text-sm">
        ...
        <a href="{{ route('admin.documents.index') }}"
          ...
          <svg class="w-5 h-5 opacity-80 group-hover:opacity-100" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-width="1.6" stroke-linecap="round" d="M8 4h8l4 4v12a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2Z"/><path stroke-width="1.6" d="M16 4v4h4"/></svg>
